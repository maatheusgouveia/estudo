...
$_SESSION['pagina'] = "cadastraCategoria.php";
$idPessoa = $_SESSION['idPessoa'];
include verificaPermissao;
 ?>
<div class="col-md-10" style="background-color:#FFF;">

  <button type="button" class="btn btn-md" onclick="Mudarestado('DivQueSome')" style="color: #fff;background-color: #8a2be2;border: 2px solid #8a2be2;margin-top: 5px;">Nova Categoria</button>
  ...
  <div id="DivQueSome" class="well-lg" style="background-color: #fff;margin-top: 20px;display:none;border: 2px solid lightgray;border-radius: 4px;">
   ...
   <h1 style="text-align: center;font-weight: bold;font-size: 1.5em;margin-top: 5px;">Cadastrar categoria</h1>
...
function Mudarestado(el) {
   ...
   <form method="POST" action="acoes/executaCadastraCategoria.php" enctype="multipart/form-data">
 <div class="form-group">
 <label style="font-weight: bold;">Nome da categoria:<span class="asterisco" style="color:	#9400D3;">*</span></label>
 <input type="text" id="NomeCategoria" name="NomeCategoria" required size="25" class="form-control" style="height: 40px;">
 </div>
...
<div class="">
  ...
  <div class="well-lg" style="background-color: #fff;margin-top: 20px;min-height:;margin-bottom:20px;border: 2px solid lightgray;border-radius: 4px;">
    ...
    <h1 style="text-align: center;font-weight: bold;font-size: 1.5em;margin-top: 5px;">Categorias cadastradas</h1>
  ...
  $executaQueryCategoria = $mysqli->query($queryCategoria);

  $linhasC = $executaQueryCategoria->num_rows;
     ...
     <tbody>
        ...
        while($dadosC= $executaQueryCategoria->fetch_assoc())
        {//inicio do while?>
              <tr>

         <td><?php echo $dadosC['NomeCategoria']; ?></td>
         <!--  <td><button class="btn  btn-sm">Detalhes</button></td> -->
         <td><button class="btn-warning  btn-sm" style="color: #fff;">Editar</button></td>
         <td><a href="acoes/excluiCategoria.php?idCategoria=<?php echo $dadosC['idCategoria']; ?>"><button class="btn btn-danger btn-sm" style="color: #fff;">Excluir</button></a></td>
         </tr>
         <?php }   //fim do while

...
<div class="col-md-10" style="background-color:#FFF;">
  ...
  <button type="button" class="btn btn-md" onclick="Mudarestado('DivQueSome2');" style="color: #fff;background-color: #8a2be2;border: 2px solid #8a2be2;margin-top: 5px;">Novo tipo de telefone</button>

  <div id="DivQueSome2" class="well-lg" style="background-color: #fff;margin-top: 20px;display:none;">
...
<div class="">
  ...
  <div class="well-lg" style="background-color: #fff;margin-top: 20px;min-height:;">
     <div class="well-sm" style="background-color: #8a2be2;color: #fff;height: 60px;border-radius: 5px;margin-bottom: 10px;">

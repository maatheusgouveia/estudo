...
<?php include headers; ?>
	...
	<title>Termos de Uso - Mostra Preço</title>
...
<div class="container" >
  <div class="row">
    <div class="col-sm-8 col-sm-offset-2" style="background-color: #fff;color: #666; min-height: 500px;box-shadow: 2px 2px 2px 2px;border-radius:5px;margin-top:5px;margin-bottom:10px;" >
        ...
        <h1 class="text-center" style="margin-top: 20px;font-size: 2.5em;font-weight:bold;color:#333;">Termos de Uso</h1> 
  ...
  <a href="criaConta.php"  style="text-align: center;float: right;margin-bottom: 10px;color: #8a2be2;"><i class="fa fa-reply" aria-hidden="true" style="color: #8a2be2;"></i> Voltar para a tela de cadastro</a>
</div>

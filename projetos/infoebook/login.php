  ...
  <div class="container-fluid text-center">
    <div class="container">
        <div class="row">
            <div class="col-sm-12">
            <h1>Login</h1>
            <p class="col-sm-4 col-sm-offset-4">Informe o seu e-mail e senha para acessar o painel de controle</p>
           </div>
        </div>
    </div>
  </div>
...
<input type="email" name="email" class="form-control" placeholder="Email" id="email" required autofocus="">
